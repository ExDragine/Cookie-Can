...
public class main {
    public static void main(String args[]) throws IOException {
        ...
        JSONObject VersionGroupJson =  GetJSONObjectByUrl(PaperURL+"/projects/paper/version_group/" + MinecraftVersion + "/builds");
        JSONArray VersionsList =  VersionGroupJson.getJSONArray("versions");
//        String version = VersionsList.getJSONObject(VersionsList.length()-1).toString();
        ...
        String DownloadUrl = PaperURL + "/projects/paper/versions/" +version + "/builds/" + build + "/downloads/"+download;
        Path path = Paths.get("");
        ...
        //tmp = requests.api.get(PaperURL+'/projects'+''+str(version)+'/builds/'+str(build)+"downloads/"+str(download))
